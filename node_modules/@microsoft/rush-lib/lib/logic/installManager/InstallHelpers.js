    ...
    static generateCommonPackageJson(rushConfiguration, dependencies = new Map()) {
        ...
        if (rushConfiguration.packageManager === 'pnpm') {
            ...
            if (pnpmOptions.globalNeverBuiltDependencies) {
                lodash.set(commonPackageJson, 'pnpm.neverBuiltDependencies', pnpmOptions.globalNeverBuiltDependencies);
            }
            if (pnpmOptions.globalAllowedDeprecatedVersions) {
                lodash.set(commonPackageJson, 'pnpm.allowedDeprecatedVersions', pnpmOptions.globalAllowedDeprecatedVersions);
            }
