...
const VersionMismatchFinderEntity_1 = require("./versionMismatch/VersionMismatchFinderEntity");
                        ...
                        if (mismatchedVersions) {
                            for (const mismatchedVersion of mismatchedVersions) {
                                for (const consumer of mismatchFinder.getConsumersOfMismatch(packageName, mismatchedVersion)) {
                                    if (consumer instanceof VersionMismatchFinderEntity_1.VersionMismatchFinderEntity) {
