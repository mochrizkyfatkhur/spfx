...
class BaseInstallManager {
    ...
    pushConfigurationArgs(args, options) {
        if (this._rushConfiguration.packageManager === 'npm') {
            ...
            if (semver.satisfies(this._rushConfiguration.packageManagerToolVersion, '6.32.12 - 6.33.x || 7.0.1 - 7.8.x')) {
            ...
            if (semver.gte(this._rushConfiguration.packageManagerToolVersion, '7.9.0') ||
