...
class RushConfiguration {
    ...
    constructor(rushConfigurationJson, rushJsonFilename) {
        ...
        this._npmOptions = new NpmOptionsConfiguration_1.NpmOptionsConfiguration(rushConfigurationJson.npmOptions || {});
        this._yarnOptions = new YarnOptionsConfiguration_1.YarnOptionsConfiguration(rushConfigurationJson.yarnOptions || {});
        try {
            this._pnpmOptions = PnpmOptionsConfiguration_1.PnpmOptionsConfiguration.loadFromJsonFileOrThrow(`${this._commonRushConfigFolder}/${RushConstants_1.RushConstants.pnpmConfigFilename}`, this._commonTempFolder);
            ...
            if (node_core_library_1.FileSystem.isNotExistError(error)) {
                this._pnpmOptions = PnpmOptionsConfiguration_1.PnpmOptionsConfiguration.loadFromJsonObject(rushConfigurationJson.pnpmOptions || {}, this._commonTempFolder);
            }
            else {
                throw error;
            }
     ...
     * The commit message to use when committing change log files 'rush version'
     */
    get gitChangefilesCommitMessage() {
