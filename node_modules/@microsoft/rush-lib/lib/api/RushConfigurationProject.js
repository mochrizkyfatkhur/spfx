...
class RushConfigurationProject {
    ...
    constructor(options) {
        ...
        try {
            this._packageJson = node_core_library_1.JsonFile.load(packageJsonFilename, { jsonSyntax: node_core_library_1.JsonSyntax.Strict });
        }
        catch (error) {
        ...
        if (!semver.valid(this._packageJson.version)) {
            throw new Error(`The value "${this._packageJson.version}" is not valid SemVer syntax for the \"version\" field` +
        ...
        this._decoupledLocalDependencies = new Set();
     ...
     */
    get decoupledLocalDependencies() {
