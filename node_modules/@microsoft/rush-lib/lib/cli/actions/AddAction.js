    ...
    async runAsync() {
        ...
        for (const specifiedPackageName of specifiedPackageNameList) {
            ...
            if (version && version !== 'latest') {
                ...
                rangeStyle = "passthrough" /* packageJsonUpdater.SemVerStyle.Passthrough */;
            }
            else {
                rangeStyle = this._caretFlag.value
                    ? "caret" /* packageJsonUpdater.SemVerStyle.Caret */
                    : this._exactFlag.value
                        ? "exact" /* packageJsonUpdater.SemVerStyle.Exact */
                        : "tilde" /* packageJsonUpdater.SemVerStyle.Tilde */;
            }
