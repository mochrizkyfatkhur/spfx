...
class ServeTask extends gulp_core_build_1.GulpTask {
    ...
    async _loadHttpsServerOptionsAsync() {
        if (this.taskConfig.https) {
            const result = {};
            ...
            if (this.taskConfig.pfxPath) {
                ...
                const devCertificate = await certificateManager.ensureCertificateAsync(this.taskConfig.tryCreateDevCertificate, this._terminal);
