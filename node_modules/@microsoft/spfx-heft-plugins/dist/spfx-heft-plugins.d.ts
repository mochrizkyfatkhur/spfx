...
export declare class _AzureUploader {
     ...
     */
    uploadFilesToAzureAsync(terminal: Terminal, files: _IUploadableFile[], maxParallelism?: number, maxRetries?: number, retryDelayMs?: number, onFileUploaded?: (serverPath: string) => void): Promise<void>;
