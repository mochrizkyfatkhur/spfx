...
class CumulativeManifestProcessor {
    ...
    async generateCumulativeManifestAsync(debugManifests, manifestsJsFileMetadata) {
        ...
        await manifestsFileBuilder.buildManifestsJsAsync(manifestsArray, path.join(this._options.rootPath, this._options.tempFolderName, `${CUMULATIVE_MANIFEST_FILENAME}.js`), undefined, manifestsJsFileMetadata);
    }
    reset() {
