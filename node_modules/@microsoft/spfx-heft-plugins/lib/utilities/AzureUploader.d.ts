...
export declare class AzureUploader {
     ...
     */
    uploadFilesToAzureAsync(terminal: Terminal, files: IUploadableFile[], maxParallelism?: number, maxRetries?: number, retryDelayMs?: number, onFileUploaded?: (serverPath: string) => void): Promise<void>;
