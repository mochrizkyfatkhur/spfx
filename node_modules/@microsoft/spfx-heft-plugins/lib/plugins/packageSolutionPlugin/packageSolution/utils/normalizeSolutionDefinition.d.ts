 ...
 */
export default function normalizeSolutionDefinition(terminal: Terminal, options: IPackageSolutionConfig, manifests: Map<string, IClientSideComponentManifest>): void;
