...
class CustomizeWebpackConfigurationPlugin {
    constructor() {
        this.pluginName = PluginNames.CustomizeWebpackConfigPlugin;
    }
    apply(heftSession, heftConfiguration, options) {
        ...
        heftSession.hooks.build.tap(PluginNames.SpfxWebpackConfigurationPlugin, (build) => {
            build.hooks.bundle.tap(PluginNames.SpfxWebpackConfigurationPlugin, (bundleSubstage) => {
                bundleSubstage.hooks.configureWebpack.tapPromise({
                    name: PluginNames.SpfxWebpackConfigurationPlugin,
