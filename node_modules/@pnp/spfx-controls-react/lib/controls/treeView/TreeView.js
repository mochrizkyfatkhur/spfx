...
var TreeView = /** @class */ (function (_super) {
    ...
    TreeView.prototype.componentWillReceiveProps = function (nextProps) {
        var items = nextProps.items, defaultSelectedKeys = nextProps.defaultSelectedKeys, selectChildrenIfParentSelected = nextProps.selectChildrenIfParentSelected;
        if (defaultSelectedKeys) {
            var selectedItems = !defaultSelectedKeys ? [] : this.getSelectedItems(items, defaultSelectedKeys, selectChildrenIfParentSelected);
            this.setState({
                activeItems: selectedItems
            });
        }
