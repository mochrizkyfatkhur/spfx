...
export function AnimatedDialog(props) {
    ...
    useEffect(function () {
        ...
        setAnimatedDialogContentProps(__assign({}, dialogContentProps, { title: title }));
    }, []);
    useEffect(function () {
    ...
    useEffect(function () {
        ...
        setDialogProps(__assign({}, props, { dialogContentProps: animatedDialogContentProps, modalProps: __assign({}, modalProps, { containerClassName: containerClassName }) }));
    }, [props.hidden]);
