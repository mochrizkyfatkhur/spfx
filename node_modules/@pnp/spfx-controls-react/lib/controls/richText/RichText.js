    ...
    function RichText(props) {
        ...
        _this.renderLinkDialog = function () {
            return (React.createElement(Dialog, { hidden: _this.state.hideDialog, onDismiss: _this.closeDialog, dialogContentProps: {
                ...
                React.createElement(TextField, { label: strings.AddressFieldLabel, value: _this.state.insertUrl !== undefined ? _this.state.insertUrl : "https://", onChanged: function (newValue) {
                        _this.setState({
                            insertUrl: newValue
                        });
                    } }),
                React.createElement(TextField, { label: strings.TextToDisplayLabel, value: _this.state.insertUrlText, onChanged: function (newValue) {
        ...
        * Renders the "Insert Image" dialog
        ...
        _this.renderImageDialog = function () {
            return (React.createElement(Dialog, { hidden: _this.state.hideImageDialog, onDismiss: _this.closeImageDialog, dialogContentProps: {
                ...
                React.createElement(TextField, { label: strings.AddressFieldLabel, value: _this.state.insertImageUrl !== undefined ? _this.state.insertImageUrl : "", onChanged: function (newValue) {
                        _this.setState({
