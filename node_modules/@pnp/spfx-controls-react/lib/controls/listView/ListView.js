            ...
            React.createElement("div", { className: styles.DragDropArea, ref: this.dropRef },
                ...
                showFilter &&
                    React.createElement(SearchBoxWrapper, { stickyHeader: !!this.props.stickyHeader },
                        React.createElement(SearchBox, { placeholder: filterPlaceHolder || strings.ListViewFilterLabel, onSearch: this._updateFilterValue, onChange: this._updateFilterValue, value: filterValue })),
