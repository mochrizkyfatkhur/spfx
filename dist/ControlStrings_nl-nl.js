define([], function () {
    return {
        ...
        "TaxonomyPickerTermsNotFound": "De volgende geselecteerde term(en) zijn niet gevonden in het termenarchief: {0}",
        "TaxonomyPickerInvalidTerms": "Gelieve ongeldige termijn(en) vast te stellen: {0}",
